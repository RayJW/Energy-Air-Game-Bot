...
function total(){
    if (won1 == "Du hast die erste Hürde gepackt. Um welchen Preis möchtest du spielen?"){
        var text = document.getElementsByClassName("container-fluid decision")
        var won1 = text[0].innerText;
        document.getElementsByClassName("tickets").click();
    }
    else{
        initial()
        function initial(){
